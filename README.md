...
One key to open reproducible science is to provide rigorous organization of all workflow code. Not just for when you send your project to someone else though. A future version of yourself will also benefit when you return to an organized project after some time away.
